  ...
  return (
    <section id='experience' ref={experienceRef}>
      ...
      <ExpCard
        ...
        left={
          <div className='exp-company'>
            <img className='com-avatar' src='./assets/hh.webp' alt='' loading='lazy' decoding='async' />
      ...
      <ExpCard
        ...
        left={
          <div className='exp-company'>
            <img className='com-avatar' src='./assets/vk.webp' alt='' loading='lazy' decoding='async' />
            <div className='c-name'>
              <h3>vk реклама</h3>
      ...
      <ExpCard
        ...
        left={
          <div className='exp-company'>
            <img className='com-avatar' src='./assets/mg.webp' alt='' loading='lazy' decoding='async' />
            <div className='c-name'>
              <h3>it megastar</h3>
